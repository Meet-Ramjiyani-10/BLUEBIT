...
const TECH = [
  ...
  { name: 'Vision Transformer', color: '#2563EB' },
  { name: 'wav2vec 2.0', color: '#7C3AED' },
  { name: 'C2PA', color: '#06B6D4' },
];
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans antialiased">
      ...
      {/* ═══════ SECTION NAVIGATION ═══════ */}
      <div className="sticky top-16 z-40 bg-white/90 backdrop-blur-xl border-b border-[#E2E8F0]/60">
        <div className="max-w-6xl mx-auto px-6 py-2.5 flex items-center justify-center">
          <div className="inline-flex items-center bg-[#F1F5F9] rounded-xl p-1 gap-0.5">
            {SECTIONS.map((s) => (
              <button
                key={s.id}
                data-section={s.id}
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-12 pb-16 md:pt-16 md:pb-24">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-xs font-semibold text-[#2563EB]">AI-Powered · Multi-Modal · Forensic Platform</span>
              </div>

              <h1 className="text-3xl md:text-[46px] font-extrabold tracking-tight leading-[1.1] text-[#0F172A]">
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                { icon: Fingerprint, title: 'Provenance Tracking', desc: 'Verifies digital signatures, EXIF metadata, and camera PRNU fingerprints to trace content origin.', color: '#06B6D4' },
                { icon: Scissors, title: 'Partial Manipulation Detection', desc: 'Finds subtle edits including removed frames, audio splices, and color grading shifts invisible to the naked eye.', color: '#EF4444' },
                { icon: Timer, title: 'Real-Time & Batch Processing', desc: 'Analyzes images in under 1 second, processes 30-second videos in under 60 seconds, and supports multi-file batch queues.', color: '#22C55E' },
              ].map((f) => {
                const Icon = f.icon;
                return (
        ...
        <section className="py-20 md:py-28 bg-white border-y border-[#E2E8F0]">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="rounded-2xl border border-[#E2E8F0] bg-[#FAFBFC] overflow-hidden">
                <div className="flex items-center gap-3 px-6 py-4 border-b border-[#F1F5F9] bg-white">
                  <span className="w-7 h-7 rounded-lg bg-[#2563EB]/10 text-[#2563EB] font-bold text-xs flex items-center justify-center">5</span>
              ...
              <div className="rounded-2xl border border-[#E2E8F0] bg-[#FAFBFC] overflow-hidden">
                <div className="flex items-center gap-3 px-6 py-4 border-b border-[#F1F5F9] bg-white">
                  <span className="w-7 h-7 rounded-lg bg-[#7C3AED]/10 text-[#7C3AED] font-bold text-xs flex items-center justify-center">6</span>
              ...
              <div className="rounded-2xl border border-[#E2E8F0] bg-[#FAFBFC] overflow-hidden">
                <div className="flex items-center gap-3 px-6 py-4 border-b border-[#F1F5F9] bg-white">
                  <span className="w-7 h-7 rounded-lg bg-[#06B6D4]/10 text-[#06B6D4] font-bold text-xs flex items-center justify-center">7</span>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                { icon: Crosshair, title: 'Cross-Modal Lip Sync', desc: 'Verifies audio-video coherence using phoneme-to-viseme alignment scoring across every frame.', color: '#2563EB' },
                { icon: Fingerprint, title: 'Provenance & Signatures', desc: 'Extracts EXIF data, validates C2PA digital signatures, and checks camera sensor fingerprints.', color: '#7C3AED' },
                { icon: Scissors, title: 'Partial Edit Detection', desc: 'Detects removed frames, audio splices, object removal, and color grading with before/after comparison.', color: '#EF4444' },
                { icon: Layers, title: 'Batch Processing', desc: 'Queue multiple files across media types and process them simultaneously with a live status dashboard.', color: '#06B6D4' },
              ].map((f) => {
                const Icon = f.icon;
                return (
                  <div key={f.title} className="flex gap-5 p-6 rounded-2xl border border-[#E2E8F0] hover:border-[#CBD5E1] hover:shadow-lg hover:shadow-black/[0.02] transition-all bg-[#FAFBFC]">
            ...
            <div className="flex flex-wrap justify-center gap-x-16 gap-y-8">
              {[
                ...
                <div key={stat.label} className="text-center">
                  <p className="text-3xl md:text-4xl font-bold tracking-tight text-[#2563EB]">
                    {stat.number}
                  </p>
                  <p className="text-sm text-[#475569] font-medium mt-2">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
